% Produced by CVXGEN, 2020-02-21 17:35:54 -0500.
...
cvx_begin
  ...
  subject to
    ...
    dt*Jt_19(1)*x(1) + dt*Jt_19(2)*x(2) + dt*Jt_19(3)*x(3) + dt*Jt_19(4)*x(4) + dt*Jt_19(5)*x(5) + dt*Jt_19(6)*x(6) + dt*Jt_19(24)*x(24) + dt*Jt_19(25)*x(25) + dt*Jt_19(26)*x(26) + dt*Jt_19(27)*x(27) + dt*Jt_19(28)*x(28) + dt*Jt_19(29)*x(29) + w(31) == b4(1);
    dt*Jt_20(1)*x(1) + dt*Jt_20(2)*x(2) + dt*Jt_20(3)*x(3) + dt*Jt_20(4)*x(4) + dt*Jt_20(5)*x(5) + dt*Jt_20(6)*x(6) + dt*Jt_20(24)*x(24) + dt*Jt_20(25)*x(25) + dt*Jt_20(26)*x(26) + dt*Jt_20(27)*x(27) + dt*Jt_20(28)*x(28) + dt*Jt_20(29)*x(29) + w(32) == b4(2);
    dt*Jt_21(1)*x(1) + dt*Jt_21(2)*x(2) + dt*Jt_21(3)*x(3) + dt*Jt_21(4)*x(4) + dt*Jt_21(5)*x(5) + dt*Jt_21(6)*x(6) + dt*Jt_21(24)*x(24) + dt*Jt_21(25)*x(25) + dt*Jt_21(26)*x(26) + dt*Jt_21(27)*x(27) + dt*Jt_21(28)*x(28) + dt*Jt_21(29)*x(29) + w(33) == b4(3);
    dt*Jt_22(1)*x(1) + dt*Jt_22(2)*x(2) + dt*Jt_22(3)*x(3) + dt*Jt_22(4)*x(4) + dt*Jt_22(5)*x(5) + dt*Jt_22(6)*x(6) + dt*Jt_22(24)*x(24) + dt*Jt_22(25)*x(25) + dt*Jt_22(26)*x(26) + dt*Jt_22(27)*x(27) + dt*Jt_22(28)*x(28) + dt*Jt_22(29)*x(29) + w(34) == b4(4);
    dt*Jt_23(1)*x(1) + dt*Jt_23(2)*x(2) + dt*Jt_23(3)*x(3) + dt*Jt_23(4)*x(4) + dt*Jt_23(5)*x(5) + dt*Jt_23(6)*x(6) + dt*Jt_23(24)*x(24) + dt*Jt_23(25)*x(25) + dt*Jt_23(26)*x(26) + dt*Jt_23(27)*x(27) + dt*Jt_23(28)*x(28) + dt*Jt_23(29)*x(29) + w(35) == b4(5);
    dt*Jt_24(1)*x(1) + dt*Jt_24(2)*x(2) + dt*Jt_24(3)*x(3) + dt*Jt_24(4)*x(4) + dt*Jt_24(5)*x(5) + dt*Jt_24(6)*x(6) + dt*Jt_24(24)*x(24) + dt*Jt_24(25)*x(25) + dt*Jt_24(26)*x(26) + dt*Jt_24(27)*x(27) + dt*Jt_24(28)*x(28) + dt*Jt_24(29)*x(29) + w(36) == b4(6);
    dt*Jt_25(1)*x(1) + dt*Jt_25(2)*x(2) + dt*Jt_25(3)*x(3) + dt*Jt_25(4)*x(4) + dt*Jt_25(5)*x(5) + dt*Jt_25(6)*x(6) + dt*Jt_25(30)*x(30) + dt*Jt_25(31)*x(31) + dt*Jt_25(32)*x(32) + dt*Jt_25(33)*x(33) + dt*Jt_25(34)*x(34) + dt*Jt_25(35)*x(35) + w(37) == b4(7);
    dt*Jt_26(1)*x(1) + dt*Jt_26(2)*x(2) + dt*Jt_26(3)*x(3) + dt*Jt_26(4)*x(4) + dt*Jt_26(5)*x(5) + dt*Jt_26(6)*x(6) + dt*Jt_26(30)*x(30) + dt*Jt_26(31)*x(31) + dt*Jt_26(32)*x(32) + dt*Jt_26(33)*x(33) + dt*Jt_26(34)*x(34) + dt*Jt_26(35)*x(35) + w(38) == b4(8);
    dt*Jt_27(1)*x(1) + dt*Jt_27(2)*x(2) + dt*Jt_27(3)*x(3) + dt*Jt_27(4)*x(4) + dt*Jt_27(5)*x(5) + dt*Jt_27(6)*x(6) + dt*Jt_27(30)*x(30) + dt*Jt_27(31)*x(31) + dt*Jt_27(32)*x(32) + dt*Jt_27(33)*x(33) + dt*Jt_27(34)*x(34) + dt*Jt_27(35)*x(35) + w(39) == b4(9);
    dt*Jt_28(1)*x(1) + dt*Jt_28(2)*x(2) + dt*Jt_28(3)*x(3) + dt*Jt_28(4)*x(4) + dt*Jt_28(5)*x(5) + dt*Jt_28(6)*x(6) + dt*Jt_28(30)*x(30) + dt*Jt_28(31)*x(31) + dt*Jt_28(32)*x(32) + dt*Jt_28(33)*x(33) + dt*Jt_28(34)*x(34) + dt*Jt_28(35)*x(35) + w(40) == b4(10);
    dt*Jt_29(1)*x(1) + dt*Jt_29(2)*x(2) + dt*Jt_29(3)*x(3) + dt*Jt_29(4)*x(4) + dt*Jt_29(5)*x(5) + dt*Jt_29(6)*x(6) + dt*Jt_29(30)*x(30) + dt*Jt_29(31)*x(31) + dt*Jt_29(32)*x(32) + dt*Jt_29(33)*x(33) + dt*Jt_29(34)*x(34) + dt*Jt_29(35)*x(35) + w(41) == b4(11);
    dt*Jt_30(1)*x(1) + dt*Jt_30(2)*x(2) + dt*Jt_30(3)*x(3) + dt*Jt_30(4)*x(4) + dt*Jt_30(5)*x(5) + dt*Jt_30(6)*x(6) + dt*Jt_30(30)*x(30) + dt*Jt_30(31)*x(31) + dt*Jt_30(32)*x(32) + dt*Jt_30(33)*x(33) + dt*Jt_30(34)*x(34) + dt*Jt_30(35)*x(35) + w(42) == b4(12);
    x(7) + w(37) == b3(37);
    x(8) + w(38) == b3(38);
    x(9) + w(39) == b3(39);
    x(10) + w(40) == b3(40);
