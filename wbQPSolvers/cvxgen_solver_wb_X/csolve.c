/* Produced by CVXGEN, 2020-02-21 17:35:53 -0500.  */
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
  ...
  if (xm == NULL) {
    ...
    if (!((mxGetM(xm) == 82) && (mxGetN(xm) == 1))) {
      printf("Qw must be size (82,1), not (%d,%d).\n", mxGetM(xm), mxGetN(xm));
      this_var_errors++;
    }
    if (mxIsComplex(xm)) {
  ...
  if (xm == NULL) {
    ...
    if (!((mxGetM(xm) == 82) && (mxGetN(xm) == 1))) {
      printf("b3 must be size (82,1), not (%d,%d).\n", mxGetM(xm), mxGetN(xm));
      this_var_errors++;
    }
    if (mxIsComplex(xm)) {
  ...
  *mxGetPr(xm) = work.converged;
  ...
  xm = mxCreateDoubleMatrix(82, 1, mxREAL);
