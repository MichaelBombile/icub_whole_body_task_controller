...
float wb2_randn_internal(long *idum, int reset) {
  ...
  if (iset==0) {
    do {
      v1 = 2.0*wb2_ran1(idum, reset)-1.0;
      v2 = 2.0*wb2_ran1(idum, reset)-1.0;
      rsq = v1*v1+v2*v2;
...
double wb2_randn(void) {
  return wb2_randn_internal(&wb2_global_seed, 0);
}
void wb2_reset_rand(void) {
  srand(15);
  wb2_global_seed = 1;
  wb2_randn_internal(&wb2_global_seed, 1);
}
