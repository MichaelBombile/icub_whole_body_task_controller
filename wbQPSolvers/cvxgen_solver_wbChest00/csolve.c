/* Produced by CVXGEN, 2020-06-01 20:41:31 -0400.  */
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
  ...
  this_var_errors = 0;
  xm = mxGetField(prhs[0], 0, "Jto_1");
  if (xm == NULL) {
    /* Attempt to pull Jto_1 from a cell array, as an additional option. */
    cell = mxGetField(prhs[0], 0, "Jto");
    if (cell != NULL)
      xm = mxGetCell(cell, 0);
  }
  if (xm == NULL) {
    printf("could not find params.Jto_1 or params.Jto{1}.\n");
  } else {
    if (!((mxGetM(xm) == 35) && (mxGetN(xm) == 1))) {
      printf("Jto_1 must be size (35,1), not (%d,%d).\n", mxGetM(xm), mxGetN(xm));
      this_var_errors++;
    }
    if (mxIsComplex(xm)) {
      printf("parameter Jto_1 must be real.\n");
      this_var_errors++;
    }
    if (!mxIsClass(xm, "double")) {
      printf("parameter Jto_1 must be a full matrix of doubles.\n");
      this_var_errors++;
    }
    if (mxIsSparse(xm)) {
      printf("parameter Jto_1 must be a full matrix.\n");
      this_var_errors++;
    }
    if (this_var_errors == 0) {
      dest = params.Jto_1;
  ...
  this_var_errors = 0;
  xm = mxGetField(prhs[0], 0, "Jto_2");
  if (xm == NULL) {
    /* Attempt to pull Jto_2 from a cell array, as an additional option. */
    cell = mxGetField(prhs[0], 0, "Jto");
    if (cell != NULL)
      xm = mxGetCell(cell, 1);
  }
  if (xm == NULL) {
    printf("could not find params.Jto_2 or params.Jto{2}.\n");
  } else {
    if (!((mxGetM(xm) == 35) && (mxGetN(xm) == 1))) {
      printf("Jto_2 must be size (35,1), not (%d,%d).\n", mxGetM(xm), mxGetN(xm));
      this_var_errors++;
    }
    if (mxIsComplex(xm)) {
      printf("parameter Jto_2 must be real.\n");
      this_var_errors++;
    }
    if (!mxIsClass(xm, "double")) {
      printf("parameter Jto_2 must be a full matrix of doubles.\n");
      this_var_errors++;
    }
    if (mxIsSparse(xm)) {
      printf("parameter Jto_2 must be a full matrix.\n");
      this_var_errors++;
    }
    if (this_var_errors == 0) {
      dest = params.Jto_2;
  ...
  this_var_errors = 0;
  xm = mxGetField(prhs[0], 0, "Jto_3");
  if (xm == NULL) {
    /* Attempt to pull Jto_3 from a cell array, as an additional option. */
    cell = mxGetField(prhs[0], 0, "Jto");
    if (cell != NULL)
      xm = mxGetCell(cell, 2);
  }
  if (xm == NULL) {
    printf("could not find params.Jto_3 or params.Jto{3}.\n");
  } else {
    if (!((mxGetM(xm) == 35) && (mxGetN(xm) == 1))) {
      printf("Jto_3 must be size (35,1), not (%d,%d).\n", mxGetM(xm), mxGetN(xm));
      this_var_errors++;
    }
    if (mxIsComplex(xm)) {
      printf("parameter Jto_3 must be real.\n");
      this_var_errors++;
    }
    if (!mxIsClass(xm, "double")) {
      printf("parameter Jto_3 must be a full matrix of doubles.\n");
      this_var_errors++;
    }
    if (mxIsSparse(xm)) {
      printf("parameter Jto_3 must be a full matrix.\n");
      this_var_errors++;
    }
    if (this_var_errors == 0) {
      dest = params.Jto_3;
  ...
  if (xm == NULL) {
    ...
    if (!((mxGetM(xm) == 85) && (mxGetN(xm) == 1))) {
      printf("Qw must be size (85,1), not (%d,%d).\n", mxGetM(xm), mxGetN(xm));
      this_var_errors++;
    }
    if (mxIsComplex(xm)) {
  ...
  if (xm == NULL) {
    ...
    if (!((mxGetM(xm) == 62) && (mxGetN(xm) == 1))) {
      printf("b3 must be size (62,1), not (%d,%d).\n", mxGetM(xm), mxGetN(xm));
      this_var_errors++;
    }
    if (mxIsComplex(xm)) {
  ...
  if (xm == NULL) {
    printf("could not find params.b4.\n");
  } else {
    if (!((mxGetM(xm) == 12) && (mxGetN(xm) == 1))) {
      printf("b4 must be size (12,1), not (%d,%d).\n", mxGetM(xm), mxGetN(xm));
      this_var_errors++;
    }
    if (mxIsComplex(xm)) {
      printf("parameter b4 must be real.\n");
      this_var_errors++;
    }
    if (!mxIsClass(xm, "double")) {
      printf("parameter b4 must be a full matrix of doubles.\n");
      this_var_errors++;
    }
    if (mxIsSparse(xm)) {
      printf("parameter b4 must be a full matrix.\n");
      this_var_errors++;
    }
    if (this_var_errors == 0) {
      dest = params.b4;
  ...
  if (prepare_for_c) {
    ...
    for (i = 0; i < 35; i++)
      printf("  params.Jto_1[%d] = %.6g;\n", i, params.Jto_1[i]);
    for (i = 0; i < 35; i++)
      printf("  params.Jto_2[%d] = %.6g;\n", i, params.Jto_2[i]);
    for (i = 0; i < 35; i++)
      printf("  params.Jto_3[%d] = %.6g;\n", i, params.Jto_3[i]);
    for (i = 0; i < 6; i++)
  ...
  *mxGetPr(xm) = work.converged;
  ...
  xm = mxCreateDoubleMatrix(85, 1, mxREAL);
