...
void Discrete_CP_LIP_Model::Init(double SpTime, double CoMHeight, int CpOption)
{
...
MpcBased_CP_Model::MpcBased_CP_Model(){}
                                                  ...
                                                  int CpOption)   // LIPM model type
{
    ...
    PEs = C_nT;     // Capture point Output states matrix
    PEu = CAB_nT;   // capture point Output control matrix
    Pzs = Cz_nT;    // ZMP Output states matrix
    Pzu = CzAB_nT;  // ZMP Output control matrix
    // Rotational motion
    PzsR = PpsR;
    PzuR = PpuR;
...
// // ==============================================================================================================================================
CP_SelectionMatrices::CP_SelectionMatrices(){}
CP_SelectionMatrices::~CP_SelectionMatrices(){}


void CP_SelectionMatrices::Initialize(VectorXd SampVec,
                                  double SamplingTime,
                                  int SamplesPerStep[],
                                                    ...
                                                    int time_index)
   {
           ...
           // Test of Double support phase
               ...
               // std::cout << " STANCE COEFFICIENTS CURRENT STEP  IS : \t" << CP_LocalCurrentSel(0) << std::endl;
               // std::cout << " STANCE COEFFICIENTS NEXT STEP IS : \t" << CP_LocalFutureSel(0,0) << std::endl;
...
// =================================================================================================================
CpStanceFootPose::CpStanceFootPose(){}
CpStanceFootPose::~CpStanceFootPose(){}

void CpStanceFootPose::getCpStanceFootPose(VectorXd IniCoPrefPose)
{
                                                                      ...
                                                                      // RelCoPXYR_n1[2]    : OrienCoP_n1;
{
   ...
   //xk_fc_xy_n1.resize(2);
    if (SMx.IndexSFt == 0)
    {
        ...
        xk_fc_ang_n1    =  RelCoPXYR_n1(2);  // CoPRefR;             //RelCoPXYR_n1[2];  // Rotation (theta)
        //
...
VelocitiesSetPoints::VelocitiesSetPoints(){
  FutureStepsXY.setZero();
  FutureAngles.setZero();
};
VelocitiesSetPoints::~VelocitiesSetPoints(){};
