...
class Discrete_CP_LIP_Model
{
    ...
    public :
        ...
        void Init(double x, double y, int CpOption);
...
class CP_SelectionMatrices
{
  ...
  CP_SelectionMatrices();
  ~CP_SelectionMatrices();

  void Initialize( VectorXd SampVec,
                     double SamplingTime,
                        int SamplesPerStep[],
...
class CpStanceFootPose
{
    ...
    public :
        ...
        void getCpStanceFootPose(VectorXd IniCoPrefPose);
...
class VelocitiesSetPoints
{
       ...
       public :
           ...
           Vector6d FutureStepsXY;
           Vector3d FutureAngles;
