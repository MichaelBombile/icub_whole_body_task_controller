...
class CpQMatrix 
{
    ...
    public :
        ...
        void Init(MpcBased_CP_Model MpcModel, double GainsArray[], int CpOption);

        MatrixXd getQMx(MpcBased_CP_Model MpcModel, CP_SelectionMatrices SMx);
        MatrixXd getQMxy(MpcBased_CP_Model MpcModel, CP_SelectionMatrices SMx);
        MatrixXd getQMang(MpcBased_CP_Model MpcModel, CP_SelectionMatrices SMx);

        void QmxElements(MpcBased_CP_Model MpcModel, CP_SelectionMatrices SMx);
...

{
    ...
    CpConstraintsFootsteps();
    ~CpConstraintsFootsteps();

    void Init(CpStanceFootPose CoPRef,
                                        int SptFt[],
                                        int CtrlH,
                                   VectorXd S_Cnstr);
...
class CpConstraintsOutputZmp
{
    ...
    public :
        ...
        CpConstraintsOutputZmp();
        ~CpConstraintsOutputZmp();
        // 
        void Init(      MpcBased_CP_Model MpcModel,
