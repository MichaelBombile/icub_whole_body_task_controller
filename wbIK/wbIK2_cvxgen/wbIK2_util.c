...
float wbIK2_randn_internal(long *idum, int reset) {
  ...
  if (iset==0) {
    do {
      v1 = 2.0*wbIK2_ran1(idum, reset)-1.0;
      v2 = 2.0*wbIK2_ran1(idum, reset)-1.0;
      rsq = v1*v1+v2*v2;
...
double wbIK2_randn(void) {
  return wbIK2_randn_internal(&wbIK2_global_seed, 0);
}
void wbIK2_reset_rand(void) {
  srand(15);
  wbIK2_global_seed = 1;
  wbIK2_randn_internal(&wbIK2_global_seed, 1);
}
