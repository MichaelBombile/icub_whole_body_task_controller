...
float wbIK3_randn_internal(long *idum, int reset) {
  ...
  if (iset==0) {
    do {
      v1 = 2.0*wbIK3_ran1(idum, reset)-1.0;
      v2 = 2.0*wbIK3_ran1(idum, reset)-1.0;
      rsq = v1*v1+v2*v2;
...
double wbIK3_randn(void) {
  return wbIK3_randn_internal(&wbIK3_global_seed, 0);
}
void wbIK3_reset_rand(void) {
  srand(15);
  wbIK3_global_seed = 1;
  wbIK3_randn_internal(&wbIK3_global_seed, 1);
}
